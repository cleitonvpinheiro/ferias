...
form.addEventListener('submit', async (e) => {
  ...
  if (modeRH) {
      ...
      const payload = {
          ...
          justificativa: (justificativaRHEl && justificativaRHEl.value.trim()) ? justificativaRHEl.value.trim() : null
      };
  ...
  try {
    ...
    const body = { 
        ...
        setor, 
        inicio, 
        inicio2: isSplit(tipoGozo) ? (inicio2 || null) : null, 
        tipoGozo, 
    ...
    if (modeRH) {
       ...
       body.sugestaoData = statusRH === 'reprovado' ? sugestaoData : null;
       body.justificativa = (statusRH === 'reprovado' && justificativaRHEl) ? justificativaRHEl.value : null;
