(function () {
    ...
    const translations = {
        pt: {
            ...
            rh_nav_back_forms: 'Voltar ao Portal de Formulários',
            rh_nav_change_password: 'Alterar senha',
            ...
            rh_card_funcionarios_title: 'Colaboradores',
            rh_card_funcionarios_desc: 'Cadastro e importação de base de colaboradores (CPF/Matrícula).',
            rh_card_desligamento_title: 'Desligamento',
            rh_card_desligamento_desc: 'Formulário de entrevistas de saída e relatórios.',
            rh_card_avaliacoes_title: 'Avaliações de Desempenho',
            rh_card_avaliacoes_desc: 'Dashboard de performance: Liderança, Administrativo, Operacional e Atendimento.',
            rh_card_experiencia_title: 'Avaliações de Experiências',
            rh_card_experiencia_desc: 'Acompanhamento de período de experiência (45 e 90 dias).',
            rh_card_formularios_title: 'Gestão de Formulários',
            ...
            rh_footer: '© 2026 Família Madalosso. Acesso Restrito ao RH.',
            intranet_module_title: 'Intranet',
            intranet_feed_title: 'Feed',
            intranet_public_title: 'Intranet',
            intranet_public_subtitle: 'Comunicados, aniversariantes e eventos',
            intranet_public_footer: '© 2026 Família Madalosso.',
            intranet_public_module_title: 'Comunicados',
            intranet_public_feed_title: 'Comunicados',
            intranet_public_login: 'Login',
            intranet_public_forms: 'Formulários',
            intranet_dashboard: 'Painel',
            intranet_refresh: 'Atualizar',
            intranet_loading: 'Carregando...',
            intranet_feed_empty: 'Sem publicações.',
            intranet_feed_empty_announcements: 'Sem comunicados.',
            intranet_feed_error: 'Erro ao carregar feed.',
            intranet_badge_announcement: 'Comunicado',
            intranet_publish_title: 'Publicar',
            intranet_publish_btn: 'Publicar',
            intranet_post_title_ph: 'Título (opcional)',
            intranet_post_content_ph: 'Escreva uma atualização...',
            intranet_post_type_post: 'Post',
            intranet_post_type_announcement: 'Comunicado RH',
            intranet_events_title: 'Eventos',
            intranet_events_new: 'Novo',
            intranet_events_create: 'Criar evento',
            intranet_event_title_ph: 'Título',
            intranet_event_local_ph: 'Local (opcional)',
            intranet_event_desc_ph: 'Descrição (opcional)',
            intranet_events_empty: 'Sem eventos.',
            intranet_events_error: 'Erro ao carregar eventos.',
            intranet_birthdays_title: 'Aniversariantes',
            intranet_birthdays_empty: 'Sem aniversariantes.',
            intranet_birthdays_error: 'Erro ao carregar aniversariantes.',
            rh_nav_beneficios: 'Benefícios',
            rh_nav_disciplinar: 'Advertências e Suspensões',
            dp_popup_title: 'Alertas DP',
            dp_popup_intro: 'Você tem {total} item(ns) em atenção.',
            dp_popup_line: '{total} item(ns) • {overdue} vencido(s) • {near} próximo(s)',
            dp_popup_line_people: '{total} colaborador(es) • {overdue} vencido(s) • {near} próximo(s)',
            dp_popup_exp_title: '⏳ Experiência (45/90)',
            dp_popup_exp_btn: 'Abrir painel de experiência',
            dp_popup_ferias_title: '🏖️ Férias (fim aquisitivo)',
            dp_popup_ferias_btn: 'Abrir painel de férias',
            dp_popup_fallback: 'Alertas DP:\n- Experiência (45/90): {exp}\n- Férias (fim aquisitivo): {ferias}',
            ...
            idx_search_ph: 'Buscar formulário...',
            idx_search_empty: 'Nenhum resultado encontrado.',
            ...
            public_footer_rights: '© 2026 Família Madalosso. Todos os direitos reservados.',
            ...
            avaliacao_operacional_title: 'Avaliação de Desempenho 2026 | Operacional',
            avaliacao_operacional_subtitle: 'Formulário de avaliação para equipe operacional',
            avaliacao_adm_title: 'Avaliação de Desempenho 2026 | Administrativo',
            avaliacao_adm_subtitle: 'Formulário de avaliação para equipe administrativa',
            avaliacao_lideranca_title: 'Avaliação de Desempenho 2026 - Gestores e Líderes',
            avaliacao_lideranca_subtitle: 'Formulário de avaliação de gestores e líderes',
            avaliacao_submit: 'Enviar Avaliação',
            avaliacao_prazo_label: '🗓️ Prazo para responder:',
            avaliacao_prazo_to: 'a',
            avaliacao_intro_policy: 'Os resultados desta avaliação serão utilizados como base para os planos de desenvolvimento individual (PDI), decisões de movimentação interna, promoções ou evolução salarial, conforme a Política de Cargos e Salários.',
            avaliacao_intro_comp_admin: 'COMPETÊNCIAS ADMINISTRATIVO',
            avaliacao_intro_comp_operacional: 'COMPETÊNCIAS OPERACIONAL',
            avaliacao_intro_comp_atendimento: 'COMPETÊNCIAS ATENDIMENTO',
            avaliacao_intro_comp_lideranca: 'COMPETÊNCIAS GESTORES E LÍDERES!',
            avaliacao_intro_warning_forms: 'Quando você enviar este formulário, ele não coletará automaticamente seus detalhes, como nome e endereço de email, a menos que você mesmo o forneça.',
            avaliacao_prazo_start: 'Data inicial',
            avaliacao_prazo_end: 'Data final',
            avaliacao_prazo_save: 'Salvar prazo',
            avaliacao_prazo_saved: 'Prazo atualizado!',
            ...
            rh_dash_funcionarios_title: 'Gestão de Colaboradores',
            ...
            rh_dash_avaliacoes_title: 'Avaliações de Desempenho',
            rh_dash_avaliacoes_subtitle: 'Acompanhe as avaliações de Liderança, Administrativo, Operacional e Atendimento.',
            rh_dash_avaliacoes_search_label: 'Setor',
            rh_dash_avaliacoes_search_placeholder: 'Todos',
            ...
            rh_dash_avaliacoes_chart_avg: 'Média de Nota por Tipo',
        ...
        es: {
            ...
            rh_nav_back_forms: 'Volver al Portal de Formularios',
            rh_nav_change_password: 'Cambiar contraseña',
            ...
            rh_card_funcionarios_title: 'Colaboradores',
            rh_card_funcionarios_desc: 'Registro e importación de base de colaboradores (CPF/Matrícula).',
            rh_card_desligamento_title: 'Salida',
            rh_card_desligamento_desc: 'Formulario de entrevistas de salida e informes.',
            rh_card_avaliacoes_title: 'Evaluación de desempeño',
            rh_card_avaliacoes_desc: 'Panel de desempeño: Liderazgo, Administrativo, Operacional, Atención al cliente.',
            rh_card_experiencia_title: 'Experiencia',
            rh_card_experiencia_desc: 'Seguimiento del período de prueba (45, 90 días y 6 meses).',
            rh_card_formularios_title: 'Gestión de formularios',
            ...
            rh_footer: '© 2026 Familia Madalosso. Acceso restringido a RR. HH.',
            intranet_module_title: 'Intranet',
            intranet_feed_title: 'Feed',
            intranet_public_title: 'Intranet',
            intranet_public_subtitle: 'Comunicados, cumpleañeros y eventos',
            intranet_public_footer: '© 2026 Familia Madalosso.',
            intranet_public_module_title: 'Comunicados',
            intranet_public_feed_title: 'Comunicados',
            intranet_public_login: 'Iniciar sesión',
            intranet_public_forms: 'Formularios',
            intranet_dashboard: 'Panel',
            intranet_refresh: 'Actualizar',
            intranet_loading: 'Cargando...',
            intranet_feed_empty: 'Sin publicaciones.',
            intranet_feed_empty_announcements: 'Sin comunicados.',
            intranet_feed_error: 'Error al cargar el feed.',
            intranet_badge_announcement: 'Comunicado',
            intranet_publish_title: 'Publicar',
            intranet_publish_btn: 'Publicar',
            intranet_post_title_ph: 'Título (opcional)',
            intranet_post_content_ph: 'Escribe una actualización...',
            intranet_post_type_post: 'Publicación',
            intranet_post_type_announcement: 'Comunicado RR. HH.',
            intranet_events_title: 'Eventos',
            intranet_events_new: 'Nuevo',
            intranet_events_create: 'Crear evento',
            intranet_event_title_ph: 'Título',
            intranet_event_local_ph: 'Lugar (opcional)',
            intranet_event_desc_ph: 'Descripción (opcional)',
            intranet_events_empty: 'Sin eventos.',
            intranet_events_error: 'Error al cargar eventos.',
            intranet_birthdays_title: 'Cumpleañeros',
            intranet_birthdays_empty: 'Sin cumpleañeros.',
            intranet_birthdays_error: 'Error al cargar cumpleañeros.',
            rh_nav_beneficios: 'Beneficios',
            rh_nav_disciplinar: 'Advertencias y Suspensiones',
            dp_popup_title: 'Alertas DP',
            dp_popup_intro: 'Tienes {total} elemento(s) en atención.',
            dp_popup_line: '{total} elemento(s) • {overdue} vencido(s) • {near} próximo(s)',
            dp_popup_line_people: '{total} colaborador(es) • {overdue} vencido(s) • {near} próximo(s)',
            dp_popup_exp_title: '⏳Avaliação de Experiencia (45/90/6M)',
            dp_popup_exp_btn: 'Abrir panel de experiencia',
            dp_popup_ferias_title: '🏖️ Vacaciones (fin de devengo)',
            dp_popup_ferias_btn: 'Abrir panel de vacaciones',
            dp_popup_fallback: 'Alertas DP:\n- Avaliação de Experiencia (45/90/6M): {exp}\n- Vacaciones (fin de devengo): {ferias}',
            idx_brand: 'Portal Interno',
            ...
            idx_search_ph: 'Buscar formulario...',
            idx_search_empty: 'No se encontraron resultados.',
            ...
            public_footer_rights: '© 2026 Familia Madalosso. Todos los derechos reservados.',
            ...
            recrutamento_submit: 'Enviar Candidatura',
            avaliacao_operacional_title: 'Evaluación de Desempeño 2026 | Operacional',
            avaliacao_operacional_subtitle: 'Formulario de evaluación para el equipo operacional',
            avaliacao_adm_title: 'Evaluación de Desempeño 2026 | Administrativo',
            avaliacao_adm_subtitle: 'Formulario de evaluación para el equipo administrativo',
            avaliacao_lideranca_title: 'Evaluación de Desempeño 2026 - Gestores y Líderes',
            avaliacao_lideranca_subtitle: 'Formulario de evaluación de gestores y líderes',
            avaliacao_submit: 'Enviar Evaluación',
            avaliacao_prazo_label: '🗓️ Plazo para responder:',
            avaliacao_prazo_to: 'a',
            avaliacao_intro_policy: 'Los resultados de esta evaluación se utilizarán como base para los planes de desarrollo individual (PDI), decisiones de movilidad interna, promociones o evolución salarial, conforme a la Política de Cargos y Salarios.',
            avaliacao_intro_comp_admin: 'COMPETENCIAS ADMINISTRATIVO',
            avaliacao_intro_comp_operacional: 'COMPETENCIAS OPERATIVO',
            avaliacao_intro_comp_atendimento: 'COMPETENCIAS ATENCIÓN',
            avaliacao_intro_comp_lideranca: 'COMPETENCIAS GESTORES Y LÍDERES',
            avaliacao_intro_warning_forms: 'Cuando envíe este formulario, no recopilará automáticamente sus datos, como nombre y dirección de correo electrónico, a menos que usted los proporcione.',
            avaliacao_prazo_start: 'Fecha inicial',
            avaliacao_prazo_end: 'Fecha final',
            avaliacao_prazo_save: 'Guardar plazo',
            avaliacao_prazo_saved: '¡Plazo actualizado!',
            avaliacao_experiencia_title: 'EVALUACIÓN DE EXPERIENCIA',
            avaliacao_experiencia_subtitle: 'Seguimiento de 45, 90 días y 6 meses',
            ...
            rh_dash_funcionarios_title: 'Gestión de Colaboradores',
            ...
            rh_dash_avaliacoes_subtitle: 'Sigue las evaluaciones de Liderazgo, Administrativo, Operacional y Atención.',
            rh_dash_avaliacoes_search_label: 'Sector',
            rh_dash_avaliacoes_search_placeholder: 'Todos',
            ...
            rh_dash_avaliacoes_chart_avg: 'Promedio de Nota por Tipo',
            ...
            rh_dash_experiencia_subtitle: 'Seguimiento de 45, 90 días y 6 meses',
        ...
        en: {
            ...
            rh_nav_back_forms: 'Back to Forms Portal',
            rh_nav_change_password: 'Change password',
            ...
            rh_card_funcionarios_title: 'Collaborators',
            rh_card_funcionarios_desc: 'Register and import collaborators base (CPF/ID).',
            rh_card_desligamento_title: 'Exit Interviews',
            rh_card_desligamento_desc: 'Exit interview forms and reports.',
            rh_card_avaliacoes_title: 'Performance Evaluation',
            rh_card_avaliacoes_desc: 'Performance dashboard: Leadership, Administrative, Operations and Customer Service.',
            rh_card_experiencia_title: 'Probation',
            rh_card_experiencia_desc: 'Track probation period (45, 90 days and 6 months).',
            rh_card_formularios_title: 'Form Management',
            ...
            rh_footer: '© 2026 Madalosso Family. HR restricted access.',
            intranet_module_title: 'Intranet',
            intranet_feed_title: 'Feed',
            intranet_public_title: 'Intranet',
            intranet_public_subtitle: 'Announcements, birthdays, and events',
            intranet_public_footer: '© 2026 Madalosso Family.',
            intranet_public_module_title: 'Announcements',
            intranet_public_feed_title: 'Announcements',
            intranet_public_login: 'Sign in',
            intranet_public_forms: 'Forms',
            intranet_dashboard: 'Dashboard',
            intranet_refresh: 'Refresh',
            intranet_loading: 'Loading...',
            intranet_feed_empty: 'No posts.',
            intranet_feed_empty_announcements: 'No announcements.',
            intranet_feed_error: 'Error loading feed.',
            intranet_badge_announcement: 'Announcement',
            intranet_publish_title: 'Publish',
            intranet_publish_btn: 'Publish',
            intranet_post_title_ph: 'Title (optional)',
            intranet_post_content_ph: 'Write an update...',
            intranet_post_type_post: 'Post',
            intranet_post_type_announcement: 'HR announcement',
            intranet_events_title: 'Events',
            intranet_events_new: 'New',
            intranet_events_create: 'Create event',
            intranet_event_title_ph: 'Title',
            intranet_event_local_ph: 'Location (optional)',
            intranet_event_desc_ph: 'Description (optional)',
            intranet_events_empty: 'No events.',
            intranet_events_error: 'Error loading events.',
            intranet_birthdays_title: 'Birthdays',
            intranet_birthdays_empty: 'No birthdays.',
            intranet_birthdays_error: 'Error loading birthdays.',
            rh_nav_beneficios: 'Benefits',
            rh_nav_disciplinar: 'Warnings and Suspensions',
            dp_popup_title: 'DP Alerts',
            dp_popup_intro: 'You have {total} item(s) requiring attention.',
            dp_popup_line: '{total} item(s) • {overdue} overdue • {near} upcoming',
            dp_popup_line_people: '{total} employee(s) • {overdue} overdue • {near} upcoming',
            dp_popup_exp_title: '⏳ Probation (45/90/6M)',
            dp_popup_exp_btn: 'Open probation dashboard',
            dp_popup_ferias_title: '🏖️ Vacation accrual',
            dp_popup_ferias_btn: 'Open vacation dashboard',
            dp_popup_fallback: 'DP Alerts:\n- Probation (45/90/6M): {exp}\n- Vacation accrual: {ferias}',
            ...
            idx_search_ph: 'Search form...',
            idx_search_empty: 'No results found.',
            ...
            public_footer_rights: '© 2026 Madalosso Family. All rights reserved.',
            ...
            avaliacao_operacional_title: 'Performance Review 2026 | Operational',
            avaliacao_operacional_subtitle: 'Evaluation form for the operational team',
            avaliacao_adm_title: 'Performance Review 2026 | Administrative',
            avaliacao_adm_subtitle: 'Evaluation form for the administrative team',
            avaliacao_lideranca_title: 'Performance Review 2026 - Managers & Leaders',
            avaliacao_lideranca_subtitle: 'Evaluation form for managers and leaders',
            avaliacao_submit: 'Submit Review',
            avaliacao_prazo_label: '🗓️ Response deadline:',
            avaliacao_prazo_to: 'to',
            avaliacao_intro_policy: 'The results of this assessment will be used as a basis for individual development plans (IDP), internal mobility decisions, promotions, or salary progression, according to the Job and Salary Policy.',
            avaliacao_intro_comp_admin: 'ADMINISTRATIVE COMPETENCIES',
            avaliacao_intro_comp_operacional: 'OPERATIONAL COMPETENCIES',
            avaliacao_intro_comp_atendimento: 'CUSTOMER SERVICE COMPETENCIES',
            avaliacao_intro_comp_lideranca: 'MANAGERS & LEADERS COMPETENCIES',
            avaliacao_intro_warning_forms: 'When you submit this form, it will not automatically collect your details, such as name and email address, unless you provide them yourself.',
            avaliacao_prazo_start: 'Start date',
            avaliacao_prazo_end: 'End date',
            avaliacao_prazo_save: 'Save deadline',
            avaliacao_prazo_saved: 'Deadline updated!',
            avaliacao_experiencia_title: 'PROBATION REVIEW',
            avaliacao_experiencia_subtitle: '45, 90 day and 6 month follow-up',
            ...
            rh_dash_funcionarios_title: 'Collaborator Management',
            ...
            rh_dash_avaliacoes_subtitle: 'Track Leadership, Administrative, Operational and Service reviews.',
            rh_dash_avaliacoes_search_label: 'Department',
            rh_dash_avaliacoes_search_placeholder: 'All',
            ...
            rh_dash_avaliacoes_chart_avg: 'Average Rating by Type',
            ...
            rh_dash_experiencia_subtitle: '45, 90 day and 6 month follow-up',
    ...
    const textMap = {
        ...
        'Outros': { es: 'Otros', en: 'Others' },
        // Avaliações 2026 (competências + opções)
        'ATENDE COMPLETAMENTE': { es: 'CUMPLE COMPLETAMENTE', en: 'FULLY MEETS' },
        'ATENDE PARCIALMENTE': { es: 'CUMPLE PARCIALMENTE', en: 'PARTIALLY MEETS' },
        'NÃO ATENDE': { es: 'NO CUMPLE', en: 'DOES NOT MEET' },
        'SUPERA as expectativas': { es: 'SUPERA las expectativas', en: 'EXCEEDS expectations' },
        'ATENDE as expectativas': { es: 'CUMPLE las expectativas', en: 'MEETS expectations' },
        'VISÃO DE FUTURO': { es: 'VISIÓN DE FUTURO', en: 'FUTURE VISION' },
        'EMPATIA E COMUNICAÇÃO': { es: 'EMPATÍA Y COMUNICACIÓN', en: 'EMPATHY & COMMUNICATION' },
        'EMPREENDEDORISMO': { es: 'EMPRENDIMIENTO', en: 'ENTREPRENEURSHIP' },
        'MELHORIA CONTÍNUA': { es: 'MEJORA CONTINUA', en: 'CONTINUOUS IMPROVEMENT' },
        'ORIENTAÇÃO PARA RESULTADO E CLIENTE': { es: 'ORIENTACIÓN A RESULTADOS Y CLIENTE', en: 'RESULTS & CUSTOMER ORIENTATION' },
        'ÉTICA E INTEGRIDADE': { es: 'ÉTICA E INTEGRIDAD', en: 'ETHICS & INTEGRITY' },
        'DESENVOLVIMENTO DE PESSOAS': { es: 'DESARROLLO DE PERSONAS', en: 'PEOPLE DEVELOPMENT' },
        'GESTÃO DE PESSOAS': { es: 'GESTIÓN DE PERSONAS', en: 'PEOPLE MANAGEMENT' },
        'CONFORMIDADE': { es: 'CUMPLIMIENTO', en: 'COMPLIANCE' },
        'CONFIABILIDADE': { es: 'CONFIABILIDAD', en: 'RELIABILITY' },
        'PLANEJAMENTO E ORGANIZAÇÃO': { es: 'PLANIFICACIÓN Y ORGANIZACIÓN', en: 'PLANNING & ORGANIZATION' },
        'ADAPTABILIDADE': { es: 'ADAPTABILIDAD', en: 'ADAPTABILITY' },
        'ORGANIZAÇÃO': { es: 'ORGANIZACIÓN', en: 'ORGANIZATION' },
        'COMPROMETIMENTO': { es: 'COMPROMISO', en: 'COMMITMENT' },
        'Gestor avaliador:': { es: 'Gestor evaluador:', en: 'Manager evaluator:' },
        'Matrícula do Colaborador:': { es: 'Matrícula del colaborador:', en: 'Employee ID:' },
        'Cargo:': { es: 'Cargo:', en: 'Position:' },
        'Os resultados desta avaliação serão utilizados como base para os planos de desenvolvimento individual (PDI), decisões de movimentação interna, promoções ou evolução salarial, conforme a Política de Cargos e Salários.': { es: 'Los resultados de esta evaluación se utilizarán como base para los planes de desarrollo individual (PDI), decisiones de movilidad interna, promociones o evolución salarial, conforme a la Política de Cargos y Salarios.', en: 'The results of this assessment will be used as a basis for individual development plans (IDP), internal mobility decisions, promotions, or salary progression, according to the Job and Salary Policy.' },
        'Os resultados desta avaliação serão utilizados como base para os planos de desenvolvimento individual (PDI), decisões de movimentação interna, promoções ou evolução salarial, conforme a Política de Cargos e Salários': { es: 'Los resultados de esta evaluación se utilizarán como base para los planes de desarrollo individual (PDI), decisiones de movilidad interna, promociones o evolución salarial, conforme a la Política de Cargos y Salarios', en: 'The results of this assessment will be used as a basis for individual development plans (IDP), internal mobility decisions, promotions, or salary progression, according to the Job and Salary Policy' },
        'Quando você enviar este formulário, ele não coletará automaticamente seus detalhes, como nome e endereço de email, a menos que você mesmo o forneça.': { es: 'Cuando envíe este formulario, no recopilará automáticamente sus datos, como nombre y dirección de correo electrónico, a menos que usted los proporcione.', en: 'When you submit this form, it will not automatically collect your details, such as name and email address, unless you provide them yourself.' },
        'COMPETÊNCIAS ADMINISTRATIVO': { es: 'COMPETENCIAS ADMINISTRATIVO', en: 'ADMINISTRATIVE COMPETENCIES' },
        'COMPETÊNCIAS OPERACIONAL': { es: 'COMPETENCIAS OPERATIVO', en: 'OPERATIONAL COMPETENCIES' },
        'COMPETÊNCIAS ATENDIMENTO': { es: 'COMPETENCIAS ATENCIÓN', en: 'CUSTOMER SERVICE COMPETENCIES' },
        'COMPETÊNCIAS GESTORES E LÍDERES!': { es: 'COMPETENCIAS GESTORES Y LÍDERES', en: 'MANAGERS & LEADERS COMPETENCIES' },
        'Visão de Futuro': { es: 'Visión de futuro', en: 'Future vision' },
        'Empatia e Comunicação': { es: 'Empatía y comunicación', en: 'Empathy and communication' },
        'Empreendedorismo': { es: 'Emprendimiento', en: 'Entrepreneurship' },
        'Orientação para resultado e cliente': { es: 'Orientación a resultados y cliente', en: 'Results and customer orientation' },
        'Ética e integridade': { es: 'Ética e integridad', en: 'Ethics and integrity' },
        'Desenvolvimento de Pessoas': { es: 'Desarrollo de personas', en: 'People development' },
        'Gestão de Pessoas': { es: 'Gestión de personas', en: 'People management' },
        'Conformidade': { es: 'Cumplimiento', en: 'Compliance' },
        'Planejamento e Organização': { es: 'Planificación y organización', en: 'Planning and organization' },
        'Adaptabilidade': { es: 'Adaptabilidad', en: 'Adaptability' },
        'Confiabilidade': { es: 'Confiabilidad', en: 'Reliability' },
        'Organização': { es: 'Organización', en: 'Organization' },
        'Comprometimento': { es: 'Compromiso', en: 'Commitment' },
        'Salvar prazo': { es: 'Guardar plazo', en: 'Save deadline' },
        'Prazo atualizado!': { es: '¡Plazo actualizado!', en: 'Deadline updated!' },
        // AV Gestores/Líderes
        'O gestor é capaz de comunicar de maneira clara e inspiradora a visão estratégica da empresa para sua equipe, incentivando o alinhamento com os objetivos de longo prazo?': { es: '¿El gestor es capaz de comunicar de manera clara e inspiradora la visión estratégica de la empresa a su equipo, incentivando la alineación con los objetivos de largo plazo?', en: 'Can the manager clearly and inspiringly communicate the company’s strategic vision to the team, encouraging alignment with long-term goals?' },
        'O líder demonstra empatia e consegue se comunicar de forma eficaz com sua equipe, levando em consideração as necessidades e sentimentos individuais dos membros?': { es: '¿El líder demuestra empatía y logra comunicarse de forma eficaz con su equipo, considerando las necesidades y sentimientos individuales de los miembros?', en: 'Does the leader show empathy and communicate effectively with the team, considering members’ individual needs and feelings?' },
        'O gestor demonstra postura proativa e mentalidade voltada à melhoria contínua, identificando oportunidades e implementando ações que aprimoram processos e geram resultados inovadores?': { es: '¿El gestor demuestra una postura proactiva y una mentalidad orientada a la mejora continua, identificando oportunidades e implementando acciones que mejoran procesos y generan resultados innovadores?', en: 'Does the manager demonstrate a proactive mindset focused on continuous improvement, identifying opportunities and implementing actions that enhance processes and drive innovative results?' },
        'O líder mantém o foco na entrega de resultados e assegura que a equipe esteja comprometida com as necessidades e expectativas dos clientes?': { es: '¿El líder mantiene el foco en la entrega de resultados y asegura que el equipo esté comprometido con las necesidades y expectativas de los clientes?', en: 'Does the leader stay focused on delivering results and ensure the team is committed to customer needs and expectations?' },
        'O gestor age de maneira ética e íntegra, tomando decisões transparentes e consistentes, mesmo em situações desafiadoras?': { es: '¿El gestor actúa de manera ética e íntegra, tomando decisiones transparentes y consistentes, incluso en situaciones desafiantes?', en: 'Does the manager act ethically and with integrity, making transparent and consistent decisions even in challenging situations?' },
        'O líder investe no desenvolvimento contínuo da equipe, identificando e proporcionando oportunidades de crescimento profissional para seus membros?': { es: '¿El líder invierte en el desarrollo continuo del equipo, identificando y proporcionando oportunidades de crecimiento profesional para sus miembros?', en: 'Does the leader invest in the team’s continuous development, identifying and providing opportunities for professional growth?' },
        'O gestor demonstra habilidade na gestão de sua equipe, promovendo um ambiente de trabalho colaborativo, motivado e bem estruturado?': { es: '¿El gestor demuestra habilidad en la gestión de su equipo, promoviendo un ambiente de trabajo colaborativo, motivado y bien estructurado?', en: 'Does the manager demonstrate strong people-management skills, promoting a collaborative, motivated, and well-structured work environment?' },
        'O líder assegura que sua equipe esteja em conformidade com as políticas internas, regulamentações e normas externas, promovendo um ambiente de trabalho seguro e ético?': { es: '¿El líder asegura que su equipo cumpla con las políticas internas, regulaciones y normas externas, promoviendo un entorno de trabajo seguro y ético?', en: 'Does the leader ensure the team complies with internal policies, regulations, and external standards, promoting a safe and ethical workplace?' },
        'O gestor é capaz de planejar e organizar de maneira eficiente as atividades de sua equipe, garantindo que os recursos sejam utilizados de forma otimizada para alcançar os resultados esperados?': { es: '¿El gestor es capaz de planificar y organizar eficientemente las actividades de su equipo, garantizando que los recursos se utilicen de forma óptima para lograr los resultados esperados?', en: 'Can the manager plan and organize the team’s activities efficiently, ensuring resources are used optimally to achieve expected results?' },
        'O líder demonstra flexibilidade e capacidade de adaptação diante de mudanças, ajustando rapidamente as estratégias e mantendo a equipe motivada em situações de incerteza?': { es: '¿El líder demuestra flexibilidad y capacidad de adaptación ante cambios, ajustando rápidamente las estrategias y manteniendo al equipo motivado en situaciones de incertidumbre?', en: 'Does the leader show flexibility and adaptability to change, quickly adjusting strategies and keeping the team motivated during uncertainty?' },
        '15. O gestor entrega os resultados esperados para a sua área, considerando metas, indicadores e desempenho operacional? Justifique': { es: '15. ¿El gestor entrega los resultados esperados para su área, considerando metas, indicadores y desempeño operativo? Justifique.', en: '15. Does the manager deliver the expected results for the area, considering goals, indicators, and operational performance? Justify.' },
        '16. Considerando o desempenho e relacionamento do colaborador, cite de 2 a 3 pontos fortes e 2 a 3 pontos de desenvolvimento, indicando também ações práticas para o seu desenvolvimento no próximo período.': { es: '16. Considerando el desempeño y la relación del colaborador, mencione de 2 a 3 fortalezas y de 2 a 3 puntos de desarrollo, indicando también acciones prácticas para su desarrollo en el próximo período.', en: '16. Considering the employee’s performance and relationships, list 2–3 strengths and 2–3 development areas, also indicating practical actions for development in the next period.' },
        '17. Na sua percepção, quais são as expectativas do colaborador em relação à empresa, considerando os feedbacks compartilhados por ele?': { es: '17. En su percepción, ¿cuáles son las expectativas del colaborador con respecto a la empresa, considerando los feedbacks compartidos por él?', en: '17. In your view, what are the employee’s expectations regarding the company, considering the feedback they shared?' },
        '18. Descreva as principais atividades desempenhadas pelo colaborador ao longo deste semestre.': { es: '18. Describa las principales actividades realizadas por el colaborador a lo largo de este semestre.', en: '18. Describe the main activities performed by the employee during this semester.' },
        // AV Administrativo
        'O colaborador demonstra iniciativa em buscar novas oportunidades, está aberto a mudanças e busca compreender o direcionamento da empresa (ex: antecipa tendências, conecta suas atividades às metas do setor, propõe melhorias alinhadas ao negócio)?': { es: '¿El colaborador demuestra iniciativa para buscar nuevas oportunidades, está abierto a cambios y busca comprender la dirección de la empresa (ej.: anticipa tendencias, conecta sus actividades con metas del área, propone mejoras alineadas al negocio)?', en: 'Does the employee show initiative to seek new opportunities, remain open to change, and understand the company’s direction (e.g., anticipates trends, connects activities to team goals, proposes improvements aligned with the business)?' },
        'O colaborador mantém uma comunicação clara e respeitosa com os colegas, sendo capaz de compreender e apoiar as necessidades da equipe (ex: escuta ativamente, adapta a comunicação ao público, evita ruídos e conflitos desnecessários)?': { es: '¿El colaborador mantiene una comunicación clara y respetuosa con sus colegas, siendo capaz de comprender y apoyar las necesidades del equipo (ej.: escucha activamente, adapta la comunicación al público, evita ruidos y conflictos innecesarios)?', en: 'Does the employee communicate clearly and respectfully with colleagues, understanding and supporting team needs (e.g., active listening, adapts communication to the audience, avoids unnecessary conflicts)?' },
        'O colaborador demonstra postura inovadora e busca maneiras de melhorar seu trabalho e o ambiente (ex: sugere melhorias, questiona processos de forma construtiva, busca novas formas de executar atividades com mais eficiência)?': { es: '¿El colaborador demuestra una postura innovadora y busca maneras de mejorar su trabajo y el entorno (ej.: sugiere mejoras, cuestiona procesos de forma constructiva, busca nuevas formas de ejecutar actividades con más eficiencia)?', en: 'Does the employee demonstrate an innovative mindset and look for ways to improve their work and environment (e.g., suggests improvements, challenges processes constructively, seeks more efficient ways to perform tasks)?' },
        'O colaborador trabalha com foco em resultados, buscando qualidade e atendendo às expectativas dos clientes (ex: acompanha metas, prioriza entregas críticas, age com senso de urgência e foco na experiência do cliente)?': { es: '¿El colaborador trabaja con foco en resultados, buscando calidad y atendiendo las expectativas de los clientes (ej.: acompaña metas, prioriza entregas críticas, actúa con sentido de urgencia y foco en la experiencia del cliente)?', en: 'Does the employee focus on results, pursuing quality and meeting customer expectations (e.g., tracks goals, prioritizes critical deliveries, acts with urgency and focuses on customer experience)?' },
        'O colaborador demonstra comportamento ético, seguindo normas e valores da empresa (ex: age com transparência, cumpre regras mesmo sem supervisão, mantém confidencialidade de informações)?': { es: '¿El colaborador demuestra un comportamiento ético, siguiendo normas y valores de la empresa (ej.: actúa con transparencia, cumple reglas aun sin supervisión, mantiene confidencialidad de la información)?', en: 'Does the employee demonstrate ethical behavior, following company rules and values (e.g., acts transparently, follows rules without supervision, keeps information confidential)?' },
        'O colaborador se mostra disposto a colaborar e apoiar o desenvolvimento dos colegas (ex: compartilha conhecimento, orienta quando necessário, contribui para o crescimento do time)?': { es: '¿El colaborador muestra disposición para colaborar y apoyar el desarrollo de los compañeros (ej.: comparte conocimiento, orienta cuando es necesario, contribuye al crecimiento del equipo)?', en: 'Is the employee willing to collaborate and support colleagues’ development (e.g., shares knowledge, mentors when needed, contributes to team growth)?' },
        'Como o colaborador reage a mudanças inesperadas nas tarefas ou no ambiente (ex: ajusta prioridades com rapidez, mantém produtividade em cenários novos, demonstra abertura ao novo)?': { es: '¿Cómo reacciona el colaborador ante cambios inesperados en tareas o en el entorno (ej.: ajusta prioridades rápidamente, mantiene productividad en escenarios nuevos, demuestra apertura a lo nuevo)?', en: 'How does the employee respond to unexpected changes in tasks or environment (e.g., quickly adjusts priorities, stays productive in new scenarios, shows openness to new ways)?' },
        'O colaborador demonstra ser confiável em suas ações, palavras e posturas (ex: cumpre prazos, assume responsabilidades, transmite segurança nas entregas e informações)?': { es: '¿El colaborador demuestra ser confiable en sus acciones, palabras y actitudes (ej.: cumple plazos, asume responsabilidades, transmite seguridad en entregas e información)?', en: 'Does the employee demonstrate reliability in actions, words, and behavior (e.g., meets deadlines, takes responsibility, conveys confidence in deliveries and information)?' },
        'O colaborador organiza suas tarefas e define prioridades de forma eficaz (ex: estrutura rotina, gerencia prazos, evita retrabalho e mantém controle das atividades)?': { es: '¿El colaborador organiza sus tareas y define prioridades de forma eficaz (ej.: estructura la rutina, gestiona plazos, evita retrabajo y mantiene control de actividades)?', en: 'Does the employee organize tasks and set priorities effectively (e.g., structures routine, manages deadlines, avoids rework, keeps activities under control)?' },
        '15. Considerando o desempenho e relacionamento do colaborador, cite de 2 a 3 pontos fortes e 2 a 3 pontos de desenvolvimento, indicando também ações práticas para o seu desenvolvimento no próximo período.': { es: '15. Considerando el desempeño y la relación del colaborador, mencione de 2 a 3 fortalezas y de 2 a 3 puntos de desarrollo, indicando también acciones prácticas para su desarrollo en el próximo período.', en: '15. Considering the employee’s performance and relationships, list 2–3 strengths and 2–3 development areas, also indicating practical actions for development in the next period.' },
        '16. Na sua percepção, quais são as expectativas do colaborador em relação à empresa, considerando os feedbacks compartilhados por ele?': { es: '16. En su percepción, ¿cuáles son las expectativas del colaborador con respecto a la empresa, considerando los feedbacks compartidos por él?', en: '16. In your view, what are the employee’s expectations regarding the company, considering the feedback they shared?' },
        '17. Descreva as principais atividades desempenhadas pelo colaborador ao longo deste semestre.': { es: '17. Describa las principales actividades realizadas por el colaborador a lo largo de este semestre.', en: '17. Describe the main activities performed by the employee during this semester.' },
        // AV Operacional
        'O colaborador demonstra abertura a mudanças, busca aprender novos processos, antecipa necessidades e compreende como seu trabalho contribui para os objetivos da empresa? (Ex: demonstra abertura a mudanças, busca aprender novos processos, antecipa demandas, entende o impacto do seu trabalho nos resultados)': { es: '¿El colaborador demuestra apertura a cambios, busca aprender nuevos procesos, anticipa necesidades y comprende cómo su trabajo contribuye a los objetivos de la empresa? (Ej.: apertura a cambios, aprendizaje, anticipa demandas, entiende el impacto en resultados)', en: 'Does the employee show openness to change, learn new processes, anticipate needs, and understand how their work contributes to company goals? (e.g., open to change, learns new processes, anticipates demands, understands impact on results)' },
        'O colaborador se comunica de forma clara, objetiva e respeitosa, escuta ativamente, considera diferentes pontos de vista e contribui para um ambiente colaborativo? (Ex: comunica-se com clareza, escuta ativamente, respeita diferentes opiniões, contribui para um ambiente colaborativo)': { es: '¿El colaborador se comunica de forma clara, objetiva y respetuosa, escucha activamente, considera distintos puntos de vista y contribuye a un ambiente colaborativo? (Ej.: claridad, escucha, respeto, colaboración)', en: 'Does the employee communicate clearly, objectively, and respectfully, listen actively, consider different viewpoints, and contribute to a collaborative environment? (e.g., clarity, active listening, respect, collaboration)' },
        'O colaborador propõe melhorias, busca soluções diante de problemas, assume responsabilidades e demonstra iniciativa para ir além do esperado nas suas atividades? (Ex: propõe melhorias, busca soluções práticas, assume responsabilidades, demonstra iniciativa no dia a dia)': { es: '¿El colaborador propone mejoras, busca soluciones ante problemas, asume responsabilidades y demuestra iniciativa para ir más allá de lo esperado en sus actividades? (Ej.: propone mejoras, soluciones prácticas, responsabilidad, iniciativa)', en: 'Does the employee propose improvements, seek solutions to problems, take responsibility, and show initiative to go beyond expectations in daily work? (e.g., improvements, practical solutions, responsibility, initiative)' },
        'O colaborador atua com foco em resultados, acompanha metas, busca qualidade nas entregas e se antecipa para atender ou superar as expectativas dos clientes? (Ex: acompanha metas, prioriza entregas, mantém qualidade nas atividades, antecipa necessidades dos clientes)': { es: '¿El colaborador actúa con foco en resultados, acompaña metas, busca calidad en las entregas y se anticipa para atender o superar expectativas del cliente? (Ej.: sigue metas, prioriza entregas, mantiene calidad, anticipa necesidades)', en: 'Does the employee focus on results, track goals, pursue quality, and anticipate to meet or exceed customer expectations? (e.g., tracks goals, prioritizes deliveries, maintains quality, anticipates customer needs)' },
        'O colaborador age com transparência, cumpre normas e políticas, mantém postura profissional e trata todos com respeito, mesmo em situações desafiadoras? (Ex: age com transparência, cumpre normas e políticas, mantém postura profissional, respeita pessoas e processos)': { es: '¿El colaborador actúa con transparencia, cumple normas y políticas, mantiene postura profesional y trata a todos con respeto, incluso en situaciones desafiantes? (Ej.: transparencia, cumplimiento, postura profesional, respeto)', en: 'Does the employee act transparently, follow rules and policies, maintain professional conduct, and treat everyone with respect even in challenging situations? (e.g., transparency, compliance, professionalism, respect)' },
        'O colaborador compartilha conhecimento, apoia colegas no dia a dia, dá e recebe feedbacks e contribui ativamente para o desenvolvimento da equipe? (Ex: compartilha conhecimento, apoia colegas, troca feedbacks, contribui para o crescimento da equipe)': { es: '¿El colaborador comparte conocimiento, apoya a los compañeros, da y recibe feedback y contribuye activamente al desarrollo del equipo? (Ej.: comparte, apoya, feedback, crecimiento del equipo)', en: 'Does the employee share knowledge, support colleagues, give and receive feedback, and actively contribute to the team’s development? (e.g., shares, supports, feedback, team growth)' },
        'O colaborador segue processos e normas de forma consistente, respeita padrões operacionais e sinaliza desvios ou oportunidades de melhoria quando necessário? (Ex: segue processos e padrões, respeita normas internas, garante consistência nas atividades, sinaliza desvios)': { es: '¿El colaborador sigue procesos y normas de forma consistente, respeta estándares operativos y señala desvíos u oportunidades de mejora cuando sea necesario? (Ej.: sigue estándares, respeta normas, consistencia, señala desvíos)', en: 'Does the employee consistently follow processes and rules, respect operational standards, and flag deviations or improvement opportunities when needed? (e.g., follows standards, respects rules, consistency, flags deviations)' },
        'O colaborador planeja suas atividades, define prioridades, cumpre prazos e mantém organização que favorece a produtividade e o fluxo de trabalho? (Ex: planeja atividades, define prioridades, cumpre prazos, mantém organização no trabalho)': { es: '¿El colaborador planifica actividades, define prioridades, cumple plazos y mantiene organización que favorece productividad y flujo de trabajo? (Ej.: planifica, prioriza, cumple plazos, organiza)', en: 'Does the employee plan activities, set priorities, meet deadlines, and maintain organization that supports productivity and workflow? (e.g., plans, prioritizes, meets deadlines, stays organized)' },
        'O colaborador assume responsabilidade pelas entregas, demonstra constância, enfrenta desafios com postura positiva e mantém foco na qualidade e nos resultados? (Ex: assume responsabilidades, mantém constância nas entregas, demonstra dedicação, foca em qualidade e resultado)': { es: '¿El colaborador asume responsabilidad por las entregas, demuestra constancia, enfrenta desafíos con actitud positiva y mantiene foco en calidad y resultados? (Ej.: responsabilidad, constancia, dedicación, foco en calidad y resultados)', en: 'Does the employee take responsibility for deliveries, show consistency, face challenges positively, and stay focused on quality and results? (e.g., ownership, consistency, dedication, quality/results focus)' },
        // AV Atendimento
        'O colaborador alinha seu atendimento aos objetivos da empresa, compreende o impacto da experiência do cliente no negócio e adapta sua atuação conforme direcionamentos e mudanças? (Ex: adapta-se a mudanças, alinha atendimento aos objetivos da empresa, compreende impacto da experiência do cliente, ajusta postura conforme direcionamentos)': { es: '¿El colaborador alinea su atención a los objetivos de la empresa, comprende el impacto de la experiencia del cliente en el negocio y adapta su actuación según directrices y cambios? (Ej.: se adapta a cambios, alinea la atención, entiende el impacto, ajusta su postura)', en: 'Does the employee align customer service with company goals, understand the impact of customer experience on the business, and adapt their approach to changes and guidance? (e.g., adapts to change, aligns service to goals, understands impact, adjusts behavior)' },
        'O colaborador escuta ativamente, demonstra empatia, adapta a comunicação ao perfil do cliente e conduz interações com clareza, cordialidade e foco na solução? (Ex: escuta ativamente, demonstra empatia, adapta linguagem ao perfil do cliente, comunica-se com clareza e cordialidade)': { es: '¿El colaborador escucha activamente, demuestra empatía, adapta la comunicación al perfil del cliente y conduce interacciones con claridad, cordialidad y foco en la solución? (Ej.: escucha activa, empatía, adapta lenguaje, claridad y cordialidad)', en: 'Does the employee listen actively, show empathy, adapt communication to the customer profile, and handle interactions with clarity, courtesy, and a solution focus? (e.g., active listening, empathy, adapts language, clear and courteous)' },
        'O colaborador identifica oportunidades de melhorar a experiência do cliente, propõe soluções, antecipa necessidades e age de forma proativa diante de problemas no atendimento? (Ex: identifica oportunidades de melhoria, propõe soluções práticas, antecipa necessidades do cliente, age proativamente diante de problemas)': { es: '¿El colaborador identifica oportunidades para mejorar la experiencia del cliente, propone soluciones, anticipa necesidades y actúa de forma proactiva ante problemas en la atención? (Ej.: identifica mejoras, propone soluciones, anticipa necesidades, actúa proactivamente)', en: 'Does the employee identify opportunities to improve customer experience, propose solutions, anticipate needs, and act proactively when service issues arise? (e.g., identifies improvements, proposes solutions, anticipates needs, proactive action)' },
        'O colaborador atua com foco na satisfação do cliente, cumpre padrões de atendimento, acompanha demandas até a resolução e busca eficiência sem perder a qualidade? (Ex: acompanha demandas até a solução, prioriza entregas críticas, age com senso de urgência, mantém foco na satisfação do cliente)': { es: '¿El colaborador actúa con foco en la satisfacción del cliente, cumple estándares de atención, acompaña demandas hasta su resolución y busca eficiencia sin perder calidad? (Ej.: acompaña hasta la solución, prioriza, urgencia, foco en satisfacción)', en: 'Does the employee focus on customer satisfaction, follow service standards, track requests through resolution, and seek efficiency without losing quality? (e.g., follows through to resolution, prioritizes, urgency, satisfaction focus)' },
        'O colaborador age com transparência e respeito nas interações, cumpre combinados, mantém postura profissional e toma decisões éticas mesmo sob pressão? (Ex: age com transparência, cumpre combinados, mantém postura profissional, toma decisões éticas mesmo sob pressão)': { es: '¿El colaborador actúa con transparencia y respeto en las interacciones, cumple acuerdos, mantiene postura profesional y toma decisiones éticas incluso bajo presión? (Ej.: transparencia, cumple acuerdos, postura profesional, decisiones éticas)', en: 'Does the employee act with transparency and respect in interactions, keep commitments, maintain professional conduct, and make ethical decisions even under pressure? (e.g., transparency, keeps commitments, professionalism, ethical decisions)' },
        'O colaborador compartilha boas práticas de atendimento, apoia colegas em situações com clientes e contribui para a evolução do time na qualidade do serviço prestado? (Ex: compartilha boas práticas, apoia colegas no atendimento, orienta novos colaboradores, contribui para o desenvolvimento do time)': { es: '¿El colaborador comparte buenas prácticas de atención, apoya a colegas en situaciones con clientes y contribuye a la evolución del equipo en la calidad del servicio? (Ej.: comparte prácticas, apoya, orienta nuevos, contribuye al desarrollo)', en: 'Does the employee share good service practices, support colleagues in customer situations, and contribute to improving team service quality? (e.g., shares practices, supports, coaches new hires, contributes to team development)' },
        'O colaborador segue processos, padrões e políticas de atendimento, garantindo consistência nas informações e segurança nas interações com o cliente? (Ex: segue processos e padrões, cumpre políticas internas, garante consistência nas informações, respeita normas da empresa)': { es: '¿El colaborador sigue procesos, estándares y políticas de atención, garantizando consistencia de la información y seguridad en las interacciones con el cliente? (Ej.: sigue estándares, cumple políticas, consistencia, respeta normas)', en: 'Does the employee follow service processes, standards, and policies, ensuring consistent information and safe customer interactions? (e.g., follows standards, complies with policies, consistency, respects company rules)' },
        'O colaborador gerencia seu fluxo de atendimento, prioriza demandas, mantém controle das solicitações e evita retrabalho ou atrasos no retorno ao cliente? (Ex: gerencia fluxo de atendimentos, prioriza demandas, mantém controle de solicitações, evita retrabalho e atrasos)': { es: '¿El colaborador gestiona su flujo de atención, prioriza demandas, controla solicitudes y evita retrabajo o retrasos en la devolución al cliente? (Ej.: gestiona flujo, prioriza, controla, evita retrabajo y retrasos)', en: 'Does the employee manage their service flow, prioritize requests, keep control of tickets, and avoid rework or delays in customer follow-up? (e.g., manages flow, prioritizes, tracks requests, avoids rework/delays)' },
        'O colaborador demonstra responsabilidade com o atendimento, mantém constância mesmo em momentos de alta demanda e busca entregar uma experiência positiva ao cliente? (Ex: demonstra responsabilidade, mantém constância no desempenho, engaja-se mesmo em alta demanda, busca entregar uma experiência positiva)': { es: '¿El colaborador demuestra responsabilidad con la atención, mantiene constancia incluso en alta demanda y busca entregar una experiencia positiva al cliente? (Ej.: responsabilidad, constancia, se involucra, experiencia positiva)', en: 'Does the employee show responsibility in service, remain consistent even during high demand, and strive to deliver a positive customer experience? (e.g., responsibility, consistency, engagement, positive experience)' }
    };
    ...
    const applyTranslations = (lang) => {
        ...
        const candidates = document.querySelectorAll('label, span, p, h1, h2, h3, th, td, button, div, li, .form-section-title, .section-title');
        candidates.forEach(el => {
            ...
            if (elementChildren.length === 0) {
                ...
                const base = el.dataset && el.dataset.i18nBase ? el.dataset.i18nBase : current.trim();
                if (el.dataset && !el.dataset.i18nBase && base) el.dataset.i18nBase = base;
                if (lang === 'pt') {
                    if (el.dataset && el.dataset.i18nBase) el.textContent = el.dataset.i18nBase;
                    return;
                }
                if (textMap[base] && textMap[base][lang]) {
                    el.textContent = textMap[base][lang];
                }
                return;
            }
            ...
            Array.from(el.childNodes).forEach(node => {
                ...
                const original = originalTextNode.has(node) ? originalTextNode.get(node) : (node.nodeValue || '');
                if (!originalTextNode.has(node)) originalTextNode.set(node, original);
                if (lang === 'pt') {
        ...
        document.querySelectorAll('select option').forEach(opt => {
            ...
            const base = opt.dataset && opt.dataset.i18nBase ? opt.dataset.i18nBase : current.trim();
            if (opt.dataset && !opt.dataset.i18nBase && base) opt.dataset.i18nBase = base;
            if (!base) return;
            if (lang === 'pt') {
                if (opt.dataset && opt.dataset.i18nBase) opt.textContent = opt.dataset.i18nBase;
                return;
            }
            let mapped = null;
            // First, try direct text map
            if (textMap[base] && textMap[base][lang]) {
                mapped = textMap[base][lang];
            }
            // Then try placeholder map (match by PT text)
            if (!mapped) {
                for (const key in placeholderMap) {
                    if (placeholderMap[key].pt === base) { mapped = placeholderMap[key][lang]; break; }
                }
            }
            if (mapped) {
...
body.theme-dark .editor-sidebar{
  ...
  border-color:var(--border) !important;
    ...
    const applyLang = (lang, { persist } = { persist: true }) => {
        ...
        window.__i18nApply = () => applyTranslations(currentLang);
    ...
    const main = () => {
        ...
        window.addEventListener('i18n:refresh', () => applyTranslations(currentLang));
        try {
