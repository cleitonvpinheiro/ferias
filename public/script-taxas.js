document.addEventListener('DOMContentLoaded', () => {
    ...
    const setDepartamentosOptions = (setores) => {
        ...
        const isGestor = currentUser && ['gestor', 'supervisor', 'gerente', 'lider'].includes(currentUser.role);
    ...
    async function loadFuncionarios() {
        try {
            await loadMe();
            const isGestor = currentUser && ['gestor', 'supervisor', 'gerente'].includes(currentUser.role);
